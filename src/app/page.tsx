        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden mb-3">
          <div className="flex flex-row items-center px-4 py-1 gap-4">
            <div className="flex-1 min-w-0 pl-4">
              <p className="text-sm font-bold text-gray-400 dark:text-gray-500">생각은 사라지지만,</p>
              <p className="text-sm font-bold text-gray-800 dark:text-gray-100 mt-0.5">기록은 남습니다.</p>
            </div>
